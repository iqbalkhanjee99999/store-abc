...
function validateGoods() {
    ...
    if(project_name == ''){
        error = 1;
        title = 'Please Provide Project Name';
    }
    if(reciving_from == ''){
        error = 1;
        title = 'Please Provide Person Name';
    }

    $(carton).each(function(index) {
        if(index != numItems - 1){
            if($(this).val() == ""){
                error = 1;
                title = 'Please Provide Carton No';
            }
        }
    });
    $(column).each(function(index) {
        if(index != numItems - 1){
            if($(this).val() == ""){
                error = 1;
                title = 'Please Provide Column No';
            }
        }
    });
