                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn" style="margin-top: 10px;">
                                        <h2>{{ (Session::has('project_name') ? Session::get('project_name') : '' ) }}</h2>
                                    </div>
                                </div>
                            </div>
                            @if(session('success'))
                                ...
                                <div class="form-example-wrap mg-t-30">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                            <br>
                                            <button  onclick="validateRequest()" style="padding: 10px;" class="btn btn-success notika-btn-success pull-right">Add Request</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
