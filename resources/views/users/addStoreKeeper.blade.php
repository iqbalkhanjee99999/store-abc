                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        <h2>StoreKeeper</h2>
                                        <p>{{isset($data)? 'Edit StoreKeeper Data' : 'Add New StoreKeeper'}}</p>
                                    </div>
                                </div>
                            </div>
                            @if(count($errors) > 0)
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-example-wrap mg-t-30">
                                <div class="cmp-tb-hd cmp-int-hd">
                                    <h2>{{isset($data)? 'Edit StoreKeeper' : 'Add StoreKeeper'}}</h2>
                                </div>
                                @if(isset($data))
                                ...
                                @endif
                                <form action="{{asset('users/saveStoreKeeper')}}" method="post">
                                    {{csrf_field()}}
                                    ...
                                    <div class="form-example-int form-horizental">
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                    <div class="nk-int-st">
                                                        <input type="text" name="address" class="form-control input-md" placeholder="StoreKeeper Address" required value="{{isset($data->address) ? $data->address : old('address')}}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
