                    ...
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <ul class="nav nav-tabs">
                                <li><a href="{{asset('projects/myIdleItemsRequest')}}"><h2>Materials</h2></a></li>
                                <li class="active"><a href="{{asset('projects/myIdleToolsRequest')}}"><h2>Assets/Tools</h2></a></li>
                            </ul>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @elseif($val->storekeeper_approve == 1 && $val->is_recevied == 0)
                                                    ...
                                                    <button class="btn btn-success notika-btn-success" onclick="idleToolsRecevied({{$val->item_id}},{{$val->row_id}})">Received</button>
                                                @elseif($val->storekeeper_approve == 1 && $val->is_recevied == 1)
                                                    <label>Tools Recevied</label>
