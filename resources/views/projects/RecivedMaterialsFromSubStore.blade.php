                    ...
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <ul class="nav nav-tabs">
                                <li><a href="{{asset('projects/projectReceivedMaterials')}}"><h2>Main Store</h2></a></li>
                                <li class="active"><a href="{{asset('projects/RecivedMaterialsFromSubStore')}}"><h2>Sub Stores</h2></a></li>
                            </ul>
                        </div>
