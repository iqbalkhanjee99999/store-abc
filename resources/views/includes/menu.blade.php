                    ...
                    <nav id="dropdown">
                        <ul class=mobile-menu-nav">
                            @if(Auth::user()->user_type != 1)
                                <li><a  href="{{asset('/home')}}"><i class="fa fa-home"></i> Home</a></li>
                            @endif
                            @if(Auth::user()->user_type == 1001 || Auth::user()->user_type == 101 || Auth::user()->user_type == 2)
                                @if(Auth::user()->user_type == 2)
                                    <li><a href="{{asset('/categories/showAll')}}"><i class="notika-icon notika-edit"></i> Categories</a></li>
                                @endif
                                ...
                                @endif
                                @if(Auth::user()->user_type == 1001 || Auth::user()->user_type == 101)
                                    <li><a data-toggle="" href="{{asset('/recivingGoods')}}" ><i class="notika-icon notika-mail"></i> Receiving Goods</a></li>
                                    <li><a data-toggle="" href="{{asset('/returnedItems')}}" ><i class="notika-icon notika-mail"></i> Returned Goods</a></li>
                                @endif
                            @endif
                            @if(Auth::user()->user_type != 2)
                                @if(Auth::user()->user_type == 1001 || Auth::user()->user_type != 101)
                            ...
                            @endif
                            @if(Auth::user()->user_type == 1001 || Auth::user()->user_type == 2)
                                <li><a href="{{asset('projects/allProjects')}}"><i class="notika-icon notika-app"></i> Projects</a></li>
                            @endif
                        </ul>
                    </nav>
                </div>
                ...
                <div class="tab-content custom-menu-content">
                    <div id="Home" class="tab-pane in notika-tab-menu-bg active animated flipInX">
                        <ul class="notika-main-menu-dropdown" id="main_store">
                            ...
                            @if(Auth::user()->user_type == 1001 || Auth::user()->user_type == 2)
                                <li>
                                    <a href="{{asset('projects/allProjects')}}"><i class="notika-icon notika-app"></i> Projects</a>
                                </li>
                            @endif
                        </ul>
                    </div>
                    ...
                    @if(Auth::user()->user_type == 3|| Auth::user()->user_type == 1)
                        ...
                        <div id="mailbox" class="tab-pane notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown" id="sub_store_ul">
                                @if(Auth::user()->user_type == 1)
                                    ...
                                    <li>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="{{asset('projects/issuedToEngineers')}}">Material Issue Reports</a></li>
                                                <li><a href="{{asset('projects/toolsIssuedToSubStores')}}">Assets/Tools Issue Reports</a></li>
                                                ...
                                                <li><a href="{{asset('projects/projectReturnedMaterials')}}">Returned Goods</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                    <li>
                                ...
                                @endif
                                @if(Auth::user()->user_type == 3)
                                    <li><a href="{{asset('reports/projectInventoryList')}}/{{Session::get('project_id')}}"><i class="fa fa-list"></i> Project Inventory Lists</a></li>
